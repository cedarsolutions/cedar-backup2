...
# Revision : $Id$
# Purpose  : XSLT stylesheet for "chunked" HTML Docbook output.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
-->
<!--
   ...
   stylesheet below where html/chunk.xsl is imported (or switch to a real
   operating system).
-->

<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version='1.0'>

   <xsl:import href="http://docbook.sourceforge.net/release/xsl/1.68.1/html/chunk.xsl"/>
