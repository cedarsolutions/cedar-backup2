...
functionality was consolidated into cdwriter.py.  This mostly-empty file
remains to preserve the Cedar Backup 2 library interface.

@deprecated: This functionality has been moved to the cdwriter module.
