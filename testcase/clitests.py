...
from CedarBackup2.cli import _usage, _version, _diagnostics, _unsupported
...
class TestFunctions(unittest.TestCase):
   ...
   def testSimpleFuncs_004(self):
      """
      Test that the _unsupported() function runs without errors.
      We don't care what the output is, and we don't check.
      """
      captureOutput(_unsupported)
...
class TestOptions(unittest.TestCase):
   ...
   def testConstructor_001(self):
      ...
      self.failUnlessEqual(False, options.unsupported)
   ...
   def testConstructor_213(self):
      """
      Test constructor with argumentList=["--unsupported", ], validate=False.
      """
      options = Options(argumentList=["--unsupported", ], validate=False)
      self.failUnlessEqual(False, options.help)
      self.failUnlessEqual(False, options.version)
      self.failUnlessEqual(False, options.verbose)
      self.failUnlessEqual(False, options.quiet)
      ...
      self.failUnlessEqual(False, options.stacktrace)
      self.failUnlessEqual(False, options.diagnostics)
      self.failUnlessEqual(True, options.unsupported)
      self.failUnlessEqual([], options.actions)

   def testConstructor_214(self):
      """
      Test constructor with argumentString="--unsupported", validate=False.
      """
      options = Options(argumentString="--unsupported", validate=False)
      self.failUnlessEqual(False, options.help)
      self.failUnlessEqual(False, options.version)
      self.failUnlessEqual(False, options.verbose)
      self.failUnlessEqual(False, options.quiet)
   ...
   def testConstructor_217(self):
      """
      Test constructor with argumentList=["--unsupported", ], validate=True.
      """
      self.failUnlessRaises(ValueError, Options, argumentList=["--unsupported",], validate=True)

   def testConstructor_218(self):
      """
      Test constructor with argumentString="--unsupported", validate=True.
      """
      self.failUnlessRaises(ValueError, Options, argumentString="--unsupported", validate=True)

   def testConstructor_219(self):
      """
      Test constructor with argumentList=["-u", ], validate=True.
      """
      self.failUnlessRaises(ValueError, Options, argumentList=["-u",], validate=True)

   def testConstructor_220(self):
      """
      Test constructor with argumentString="-u", validate=True.
      """
      self.failUnlessRaises(ValueError, Options, argumentString="-u", validate=True)
   ...
   def testBuildArgumentList_016(self):
      ...
      self.failUnlessEqual(["--help", "--version", "--verbose", "--quiet", "--config", "config",
                            ...
                            "--output", "--debug", "--stack", "--diagnostics", "--unsupported", 
   ...
   def testBuildArgumentList_043(self):
      """Test with unsupported set, validate=False."""
      options = Options()
      options.unsupported = True
      argumentList = options.buildArgumentList(validate=False)
      self.failUnlessEqual(["--unsupported", ], argumentList)

   def testBuildArgumentList_044(self):
      """Test with unsupported set, validate=True."""
      options = Options()
      options.unsupported = True
      self.failUnlessRaises(ValueError, options.buildArgumentList, validate=True)
   ...
   def testBuildArgumentString_016(self):
      ...
      options.actions = ["collect", ]
      argumentString = options.buildArgumentString(validate=False)
      self.failUnlessEqual('--help --version --verbose --quiet --config "config" --full --managed --managed-only --logfile "logfile" --owner "a:b" --mode 631 --output --debug --stack --diagnostics --unsupported "collect" ', argumentString)
   ...
   def testBuildArgumentString_017(self):
      ...
      options.actions = ["collect", "stage", ]
      argumentString = options.buildArgumentString(validate=False)
      self.failUnlessEqual('--help --version --verbose --quiet --config "config" --full --logfile "logfile" --owner "a:b" --mode 631 --output --debug --stack --diagnostics --unsupported "collect" "stage" ', argumentString)
   ...
   def testBuildArgumentString_033(self):
      ...
      options.actions = ["collect", ]
      argumentString = options.buildArgumentString(validate=True)
      self.failUnlessEqual('--help --version --verbose --quiet --config "config" --full --logfile "logfile" --owner "a:b" --mode 631 --output --debug --stack --diagnostics --unsupported "collect" ', argumentString)
   ...
   def testBuildArgumentString_043(self):
      """Test with unsupported set, validate=False."""
      options = Options()
      options.unsupported = True
      argumentString = options.buildArgumentString(validate=False)
      self.failUnlessEqual("--unsupported ", argumentString)

   def testBuildArgumentString_044(self):
      """Test with unsupported set, validate=True."""
      options = Options()
      options.unsupported = True
      self.failUnlessRaises(ValueError, options.buildArgumentString, validate=True)
...
class TestActionSet(unittest.TestCase):
   ...
   def testActionSet_004(self):
      ...
      self.failUnlessEqual(None, actionSet.actionSet[0].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[0].postHooks)
   ...
   def testActionSet_008(self):
      ...
      self.failUnlessEqual(None, actionSet.actionSet[1].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[1].postHooks)
      ...
      self.failUnlessEqual(None, actionSet.actionSet[2].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[2].postHooks)
      ...
      self.failUnlessEqual(None, actionSet.actionSet[3].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[3].postHooks)
   ...
   def testActionSet_106(self):
      ...
      self.failUnlessEqual(None, actionSet.actionSet[4].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[4].postHooks)
      ...
      self.failUnlessEqual(None, actionSet.actionSet[5].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[5].postHooks)
      ...
      self.failUnlessEqual(None, actionSet.actionSet[6].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[6].postHooks)
      ...
      self.failUnlessEqual(None, actionSet.actionSet[7].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[7].postHooks)
      ...
      self.failUnlessEqual(None, actionSet.actionSet[8].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[8].postHooks)
   ...
   def testActionSet_112(self):
      ...
      self.failUnlessEqual(100, actionSet.actionSet[0].index)
      self.failUnlessEqual("collect", actionSet.actionSet[0].name)
      self.failUnlessEqual([ PreActionHook("collect", "something"), ], actionSet.actionSet[0].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[0].postHooks)
      self.failUnlessEqual(executeCollect, actionSet.actionSet[0].function)
   ...
   def testActionSet_113(self):
      ...
      self.failUnlessEqual("collect", actionSet.actionSet[0].name)
      self.failUnlessEqual(None, actionSet.actionSet[0].preHooks)
      self.failUnlessEqual([ PostActionHook("collect", "something"), ], actionSet.actionSet[0].postHooks)
      self.failUnlessEqual(executeCollect, actionSet.actionSet[0].function)
   ...
   def testActionSet_114(self):
      ...
      self.failUnlessEqual(100, actionSet.actionSet[0].index)
      self.failUnlessEqual("collect", actionSet.actionSet[0].name)
      self.failUnlessEqual([ PreActionHook("collect", "something1"), ], actionSet.actionSet[0].preHooks)
      self.failUnlessEqual([ PostActionHook("collect", "something2"), ], actionSet.actionSet[0].postHooks)
      self.failUnlessEqual(executeCollect, actionSet.actionSet[0].function)
   ...
   def testActionSet_118(self):
      ...
      self.failUnlessEqual(50, actionSet.actionSet[0].index)
      self.failUnlessEqual("one", actionSet.actionSet[0].name)
      self.failUnlessEqual([ PreActionHook("one", "extension"), ], actionSet.actionSet[0].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[0].postHooks)
      self.failUnlessEqual(isdir, actionSet.actionSet[0].function)
   ...
   def testActionSet_119(self):
      ...
      self.failUnlessEqual("one", actionSet.actionSet[0].name)
      self.failUnlessEqual(None, actionSet.actionSet[0].preHooks)
      self.failUnlessEqual([ PostActionHook("one", "extension"), ], actionSet.actionSet[0].postHooks)
      self.failUnlessEqual(isdir, actionSet.actionSet[0].function)
   ...
   def testActionSet_120(self):
      ...
      self.failUnlessEqual(50, actionSet.actionSet[0].index)
      self.failUnlessEqual("one", actionSet.actionSet[0].name)
      self.failUnlessEqual([ PreActionHook("one", "extension1"), ], actionSet.actionSet[0].preHooks)
      self.failUnlessEqual([ PostActionHook("one", "extension2"), ], actionSet.actionSet[0].postHooks)
      self.failUnlessEqual(isdir, actionSet.actionSet[0].function)
   ...
   def testActionSet_124(self):
      ...
      self.failUnlessEqual(100, actionSet.actionSet[1].index)
      self.failUnlessEqual("collect", actionSet.actionSet[1].name)
      self.failUnlessEqual([ PreActionHook("collect", "something"), ], actionSet.actionSet[1].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[1].postHooks)
      self.failUnlessEqual(executeCollect, actionSet.actionSet[1].function)
   ...
   def testActionSet_125(self):
      ...
      self.failUnlessEqual("collect", actionSet.actionSet[1].name)
      self.failUnlessEqual(None, actionSet.actionSet[1].preHooks)
      self.failUnlessEqual([ PostActionHook("collect", "something"), ], actionSet.actionSet[1].postHooks)
      self.failUnlessEqual(executeCollect, actionSet.actionSet[1].function)
   ...
   def testActionSet_128(self):
      ...
      options = OptionsConfig()
      options.hooks = [ PostActionHook("one", "extension"),
                        PreActionHook("collect", "something1"), PreActionHook("collect", "something2"),
                        PostActionHook("stage", "whatever1"), PostActionHook("stage", "whatever2"), ]
      actionSet = _ActionSet(actions, extensions, options, None, False, True)
      self.failUnless(len(actionSet.actionSet) == 2)
      self.failUnlessEqual(50, actionSet.actionSet[0].index)
      self.failUnlessEqual("one", actionSet.actionSet[0].name)
      ...
      self.failUnlessEqual(100, actionSet.actionSet[1].index)
      self.failUnlessEqual("collect", actionSet.actionSet[1].name)
      self.failUnlessEqual([ PreActionHook("collect", "something1"), PreActionHook("collect", "something2") ], actionSet.actionSet[1].preHooks)
      self.failUnlessEqual(None, actionSet.actionSet[1].postHooks)
      self.failUnlessEqual(executeCollect, actionSet.actionSet[1].function)
   ...
   def testActionSet_129(self):
      ...
      self.failUnlessEqual("stage", actionSet.actionSet[1].name)
      self.failUnlessEqual(None, actionSet.actionSet[1].preHooks)
      self.failUnlessEqual([ PostActionHook("stage", "whatever1"), PostActionHook("stage", "whatever2") ], actionSet.actionSet[1].postHooks)
      self.failUnlessEqual(executeStage, actionSet.actionSet[1].function)
